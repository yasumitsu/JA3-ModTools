...
if insideHG() and not Platform.cmdline then
	config.CrashFolder = ConvertToFileServerProjectPath("Logs/")
	CrashFolderSymbols = config.CrashFolder .. "Pdbs/"
	CrashFolderBender = config.CrashFolder .. "Crashes"
	CrashFolderSwarm = ConvertToFileServerProjectPath("SwarmBackup/*/Storage/log-crash")
	
	resolved_file = config.CrashFolder .. "Crashes/__Resolved.lua"
end
