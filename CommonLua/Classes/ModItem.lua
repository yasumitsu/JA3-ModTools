...
DefineClass.ModResourcePreset = {
	...
	EditorView = Untranslated("<color 0 143 0>Preset class:</color><Class> <color o 143 0>Id:</color> <Id>"),
}
...
DefineClass.ModResourceFont = {
	...
	EditorView = Untranslated("<color 0 143 0>Font:</color><Font>"),
}
...
DefineClass.ModResourceMap = {
	...
	EditorView = Untranslated("<color 0 143 0>Map:</color><Map>")
}
