...
function GedModItemPropsPanelTitle(obj, filter, format)
	local title
	if obj and obj.EditorName and obj.EditorName ~= "" then
		title = obj.EditorName
	elseif IsKindOf(obj, "ModDef") then
		title = "Mod"
	else
		return format
	end
