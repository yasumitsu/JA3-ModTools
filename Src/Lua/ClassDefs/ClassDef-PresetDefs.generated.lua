...
DefineClass.LootEntryInventoryItem = {
	...
	EntryView = Untranslated("Item:<color 75 105 198><item><stack_suffix>"),
	EditorName = "Item",
}
...
DefineClass.LootEntryUpgradedWeapon = {
	...
	EntryView = Untranslated("Upgraded wpn:<color 75 105 198><weapon>"),
...
DefineClass.LootEntryWeaponComponent = {
	...
	properties = {
		{ category = "Loot", id = "item", name = "Item", 
			editor = "choice", default = "", items = function (self) return PresetsCombo("WeaponComponent") end, },
	},
	EntryView = Untranslated("Wpn comp:<color 75 105 198><item>"),
